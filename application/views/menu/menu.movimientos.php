...
<div class="container" id="container">
	<h1 class="mt-3">Movimientos</h1>


	<h6 class="text-muted mt-5"> RECIBOS
	</h6>
	<div class="row mt-3">
		<div class="col-lg-4 col-sm-12 col-md-6">
			...
			<div class="info-box shadow">
				...
				<a href="#" class="text-black-50 info-box-content" >
					<span class="h5">Nuevo recibo</span>
				</a>
			</div>
		</div>
		<div class="col-lg-4 col-sm-12 col-md-6">
			<div class="info-box shadow">
				...
				<a href="#" class="text-black-50 info-box-content" >
					...
					<span class="h5">Consultar recibo</span>
	...
	<div class="row mt-3">
		<div class="col-lg-4 col-sm-12 col-md-6">
			...
			<div class="info-box shadow">
				...
				<span class="info-box-icon bg-notaria elevation-1"><i class="fa-solid fa-file-circle-plus text-light"></i></span>
				<a href="#" class="text-black-50 info-box-content" >
					<span class="h5">Corte de caja</span>
				</a>
			</div>
		</div>
		<div class="col-lg-4 col-sm-12 col-md-6">
			<div class="info-box shadow">
				...
				<a href="#" class="text-black-50 info-box-content" >
					...
					<span class="h5">Salida de caja</span>
